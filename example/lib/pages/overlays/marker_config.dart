...
class _State extends State<_Body> {
  ...
  void _showAllMaker() {
    _aMapController?.showsAnnotations(
        markerIds: [_markers.keys.toList()[0], _markers.keys.toList()[1]],
        edgeInsets: Rect.fromLTRB(100, 100, 100, 100));
  }
